...
// TODO FIXME WARNING - THIS IS A MODIFIED VERSION OF THE CHIBIOS SHELL
// IT DOESN'T PROVIDE THE USER ANY FEEDBACK, AS IT IS INTENDED TO BE
// USED TO COMMUNICATE WITH SOFTWARE - AND NOT HUMANS - VIA THE SERIAL PORT!!!!!!!
