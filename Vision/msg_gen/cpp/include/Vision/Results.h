...
struct Results_ {
  ...
  typedef int32_t _towerSize_type;
  int32_t towerSize;
...
private:
  static const char* __s_getMD5Sum_() { return "5fb63429aaf2fdd1f1810340dee4cad4"; }
public:
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, towerSize);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, towerSize);
  ...
  ROS_DEPRECATED virtual uint32_t serializationLength() const
  {
    ...
    size += ros::serialization::serializationLength(towerSize);
...
struct MD5Sum< ::Vision::Results_<ContainerAllocator> > {
  ...
  {
    return "5fb63429aaf2fdd1f1810340dee4cad4";
  }

  static const char* value(const  ::Vision::Results_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x5fb63429aaf2fdd1ULL;
  static const uint64_t static_value2 = 0xf1810340dee4cad4ULL;
};
...
struct Printer< ::Vision::Results_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::Vision::Results_<ContainerAllocator> & v) 
  {
    ...
    s << indent << "towerSize: ";
    Printer<int32_t>::stream(s, indent + "  ", v.towerSize);
